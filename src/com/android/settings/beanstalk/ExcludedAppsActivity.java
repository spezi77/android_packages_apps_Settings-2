...
public class ExcludedAppsActivity extends ListActivity implements MenuItem.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.excluded_apps_title);
        setContentView(R.layout.excluded_apps_list);
        ...
        mAppsAdapter = new AppsAdapter(this, R.layout.excluded_apps_list_item);
    ...
    private void save() {
        if (!mSaved) {
            ...
            Settings.System.putString(getContentResolver(),
                    Settings.System.APP_SIDEBAR_EXCLUDE_LIST, string.toString());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_DELETE, 0, R.string.menu_excluded_apps_delete)
    ...
    private class AppsAdapter extends ArrayAdapter<ResolveInfo> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null) {
                convertView = mInfaltor.inflate(R.layout.excluded_apps_list_item, parent, false);
            }
