...
/** @hide */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDefaultButton.setBackgroundColor(mDefaultColor);
        mDefaultButton.setClickable(true);
        mDefaultButton.setFocusable(true);
        mDefaultButton.setText(com.android.settings.R.string.current_input_method);
        mDefaultButton.setOnClickListener(new View.OnClickListener() {
             public void onClick(View v) {
                mColorPickerView.setCenterColor(mDefaultColor);
                mEditText.setText(convertToARGB(mDefaultColor));
                mTransparencyBar.setProgress(Color.alpha(mDefaultColor));
             }
         });
        ...
        setTitle(com.android.settings.R.string.dialog_indicator_color_title);
    }
